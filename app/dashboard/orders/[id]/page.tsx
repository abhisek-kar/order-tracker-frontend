    ...
    <div className="p-4 md:p-6  mx-auto">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <MapPicker
              initialLat={orderData.customerInfo.latitude}
              initialLon={orderData.customerInfo.longitude}
              selectedLat={orderData.customerInfo.latitude}
              selectedLon={orderData.customerInfo.longitude}
              selectedAddress={orderData.customerInfo.address}
              onLocationSelect={() => {
                console.log("Location selected on read-only map");
              }}
              width="100%"
              height="500px"
              showGeocoder={false}
